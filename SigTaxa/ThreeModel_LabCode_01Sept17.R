...
rm(list=ls())
workdir <- "/data/Users/kmccauley/URECA_Nasal_Dust/Ali" #Directory where you want to save data
...
mapfile <- "ureca.map_040416_R.txt" #Map file
...
mixed_effects <- FALSE #Do you want to run a mixed-effects (ME) analysis (ie, correlated samples)
